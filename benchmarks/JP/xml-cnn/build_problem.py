...
class BuildProblem:
    ...
    def preprocess(self):
        ...
        self.TEXT = data.Field(tokenize=self.tokenize, sequential=True, lower=True, fix_length=length, unk_token = '<unk>', pad_token = '<pad>')
    ...
    def run(self, trial=None):
        ...
        model = xml_cnn(params, len(self.TEXT.vocab.stoi))
