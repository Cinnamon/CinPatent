...
def main():
    ...
    parser.add_argument('--log', type=str, default='./log/', help='path to log directory')
    ...
    parser.add_argument('--fasttext', type=str, default='./data/fasttext.vec', help='path to word embedding')
    ...
    train_loader, val_loader, num_classes, fasttext_embedding = dataset(train_path=TRAIN_PATH, val_path=VAL_PATH, fasttext_path=WE, batch_size=BATCH_SIZE, max_seq_len=MAX_LENGTH)
    ...
    model, criterion, optimizer, scheduler, epochs = initialize_model(fasttext_embedding=fasttext_embedding.vectors,
