...
class Network(nn.Module):
    ...
    """
    def __init__(self, emb_size, lang: str, vocab_size=None, emb_init=None, emb_trainable=True, padding_idx=0, emb_dropout=0.2, **kwargs):
        super(Network, self).__init__()
        self.emb = Embedding(lang, vocab_size, emb_size, emb_init, emb_trainable, padding_idx, emb_dropout)
...
class AttentionRNN(Network):
    ...
    def forward(self, inputs, **kwargs):
        ...
        rnn_out = self.lstm(emb_out, lengths.detach().cpu())   # N, L, hidden_size * 2
